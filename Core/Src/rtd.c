...
char RTDCheck() {
	...
	if (!HAL_GPIO_ReadPin(Driver_Action_GPIO_Port, Driver_Action_Pin) && HAL_GPIO_ReadPin(Tractive_Active_GPIO_Port, Tractive_Active_Pin) && bseRaw > BRAKES_ACTIVATION_THRESHOLD) {
